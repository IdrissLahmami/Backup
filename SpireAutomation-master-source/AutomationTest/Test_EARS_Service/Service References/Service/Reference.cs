...
namespace Test_EARS_Service.Service {
    ...
    public interface IServices {
        ...
        void CreateTestCycle(string testName, string expectedResult, string actualResult, string result, string buildNo, System.DateTime dateOfExecution, int testType, string executionTime);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServices/CreateTestCycle", ReplyAction="http://tempuri.org/IServices/CreateTestCycleResponse")]
        System.Threading.Tasks.Task CreateTestCycleAsync(string testName, string expectedResult, string actualResult, string result, string buildNo, System.DateTime dateOfExecution, int testType, string executionTime);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicesChannel : Test_EARS_Service.Service.IServices, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicesClient : System.ServiceModel.ClientBase<Test_EARS_Service.Service.IServices>, Test_EARS_Service.Service.IServices {
        ...
        public void CreateTestCycle(string testName, string expectedResult, string actualResult, string result, string buildNo, System.DateTime dateOfExecution, int testType, string executionTime) {
            base.Channel.CreateTestCycle(testName, expectedResult, actualResult, result, buildNo, dateOfExecution, testType, executionTime);
        }
        
        public System.Threading.Tasks.Task CreateTestCycleAsync(string testName, string expectedResult, string actualResult, string result, string buildNo, System.DateTime dateOfExecution, int testType, string executionTime) {
            return base.Channel.CreateTestCycleAsync(testName, expectedResult, actualResult, result, buildNo, dateOfExecution, testType, executionTime);
        }
